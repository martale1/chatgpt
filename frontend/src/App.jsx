...
function NewsCard({ news, expanded, onToggle, getSentimentBadge, getImpactDot }) {
  return (
    <div className={`news-item${expanded ? ' news-item-expanded' : ''}`}>
      ...
      {/* Fonte come badge testuale — nessun link rotto */}
